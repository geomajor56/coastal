...
!function (t, e, i) {
    ...
    "object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define(o), "undefined" != typeof t && n(), o.Util = {
        ...
        on: function (t, e, i) {
            ...
            if (n) {
                ...
                if (d)c = o.stamp(e) + "_" + d, a = n[s], a && a[c] && (u = a[c], delete a[c], n[r]--); else if (a = n[t])for (h = 0, l = a.length; l > h; h++)if (a[h].fn === e) {
                    u = a[h], a.splice(h, 1);
                    break
                }
    ...
    s.addEventListener = s.on, s.removeEventListener = s.clearAllEventListeners = s.off, s.addOneTimeEventListener = s.once, s.fireEvent = s.fire, s.hasEventListeners = s.listens, o.Mixin = {Events: s}, function () {
        ...
        wrapLng: [-180, 180], R: 6378137, distance: function (t, e) {
        ...
        options: {pane: "overlayPane", nonBubblingEvents: []}, addTo: function (t) {
            ...
            var e = t.target;
            e.hasLayer(this) && (this._map = e, this._zoomAnimated = e._zoomAnimated, this.onAdd(e), this.getAttribution && this._map.attributionControl && this._map.attributionControl.addAttribution(this.getAttribution()), this.getEvents && e.on(this.getEvents(), this), this.fire("add"), e.fire("layeradd", {layer: this}))
        }
    }), o.Map.include({
        addLayer: function (t) {
            var e = o.stamp(t);
            ...
            var e = o.stamp(t);
            return this._layers[e] ? (this._loaded && t.onRemove(this), t.getAttribution && this.attributionControl && this.attributionControl.removeAttribution(t.getAttribution()), t.getEvents && this.off(t.getEvents(), t), delete this._layers[e], this._loaded && (this.fire("layerremove", {layer: t}), t.fire("remove")), t._map = t._mapToAdd = null, this) : this
        }, hasLayer: function (t) {
        ...
        options: {
            ...
            var s = Math.round(e), r = this._tileZoom !== s;
            ...
            var n = this._map, s = n.getZoomScale(e, i), r = n.project(t, i).floor(), a = n.getSize().divideBy(2 * s);
            ...
            if (s) {
                ...
                if (!(r > this.options.maxZoom || r < this.options.minZoom)) {
                    var a = this._getTiledPixelBounds(t, n, r), h = this._pxBoundsToTileRange(a), l = h.getCenter(), u = [];
                    for (var c in this._tiles)this._tiles[c].current = !1;
                    for (var d = h.min.y; d <= h.max.y; d++)for (var _ = h.min.x; _ <= h.max.x; _++) {
            ...
            var e = this._map, i = this.getTileSize(), n = t.scaleBy(i), s = n.add(i), r = e.wrapLatLng(e.unproject(n, t.z)), a = e.wrapLatLng(e.unproject(s, t.z));
        ...
        for (t = 0, i = s.length; i > t; t++)if (n = s[t].src, n.match(r))return o = n.split(r)[0], (o ? o + "/" : "") + "images"
    ...
    }, o.Map.mergeOptions({closePopupOnClick: !0}), o.Popup = o.Layer.extend({
        options: {
            pane: "popupPane",
            minWidth: 50,
            maxWidth: 300,
        ...
        bindPopup: function (t, e) {
            ...
            var e = t._getPopupAnchor ? t._getPopupAnchor() : [0, 0], i = this._originalPopupOffset || o.Popup.prototype.options.offset;
        ...
        addLayer: function (t) {
            ...
            return this.hasLayer(t) ? (t in this._layers && (t = this._layers[t]),
                t.removeEventParent(this), o.LayerGroup.prototype.removeLayer.call(this, t), this.fire("layerremove", {layer: t})) : this
        }, setStyle: function (t) {
        ...
        options: {padding: .1}, initialize: function (t) {
            ...
            var e = this._map.getZoomScale(t.zoom, this._zoom), i = this._map._latLngToNewLayerPoint(this._topLeft, t.zoom, t.center);
            o.DomUtil.setTransform(this._container, i, e)
        }, _updateTransform: function () {
            var t = this._map.getZoom(), e = this._map.getCenter(), i = this._map.getZoomScale(t, this._zoom), n = this._map._latLngToNewLayerPoint(this._topLeft, t, e);
        ...
        options: {smoothFactor: 1}, initialize: function (t, e) {
            ...
            for (t = 0, n = 0; h - 1 > t; t++)if (o = a[t], s = a[t + 1], i = o.distanceTo(s), n += i, n > e)return r = (n - e) / i, this._map.layerPointToLatLng([s.x - r * (s.x - o.x), s.y - r * (s.y - o.y)])
        }, getBounds: function () {
            return this._bounds
            ...
            if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
                ...
                for (e = 0, n = 0, s = this._rings.length; s > e; e++)for (h = this._rings[e], i = 0, r = h.length; r - 1 > i; i++)a = o.LineUtil.clipSegment(h[i], h[i + 1], t, i, !0), a && (l[n] = l[n] || [], l[n].push(a[0]), (a[1] !== h[i + 1] || i === r - 2) && (l[n].push(a[1]), n++))
            }
        ...
        onAdd: function () {
            ...
            var i, n;
            if (!this._hoveredLayer)for (i in this._layers)if (n = this._layers[i], n.options.interactive && n._containsPoint(e)) {
    ...
    o.DomEvent = {
        ...
        options: {
            ...
            if (this.options.collapsed) {
                o.Browser.android || o.DomEvent.on(e, {mouseenter: this._expand, mouseleave: this._collapse}, this);
    ...
    h && o.Map.addInitHook(function () {
        ...
        flyTo: function (t, e, n) {
            ...
            var g = Math.max(p.x, p.y), v = g * this.getZoomScale(f, e), y = m.distanceTo(_), P = 1.42, L = P * P, x = s(0), b = Date.now(), w = (s(1) - x) / P, T = n.duration ? 1e3 * n.duration : 1e3 * w * .8;
